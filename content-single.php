...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		...
		<p><strong>Ticket Price:</strong> <?php echo get_post_meta( $post->ID, '_unte_meta_key_ticket', true ); ?></p>
		<p><strong>Releae Date:</strong> <?php echo get_post_meta( $post->ID, '_unte_meta_key_release', true ); ?></p>
		<?php archive_genre_term(); ?>
		<?php archive_country_term(); ?>
